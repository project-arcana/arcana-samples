        ...
        if (!window.isMinimized())
        {
            ...
            handle::command_list compute_cmdlist = handle::null_command_list;
            {
...

                {
                    ...
                    tcmd.add(res.buf_input, resource_state::unordered_access, shader_domain_flag_bits::compute);
                    tcmd.add(res.buf_output, resource_state::unordered_access, shader_domain_flag_bits::compute);
                ...
                {
                    cmd::transition_resources tcmd;
                    tcmd.add(res.buf_input, resource_state::vertex_buffer, shader_domain_flag_bits::vertex);
                    tcmd.add(res.buf_output, resource_state::vertex_buffer, shader_domain_flag_bits::vertex);
                    cmd_writer.add_command(tcmd);
                }
