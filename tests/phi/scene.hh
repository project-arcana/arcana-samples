...
inline constexpr auto sample_albedo_path = massive_sample ? "res/arcana-sample-resources/phi/texture/uv_checker.png" : "res/arcana-sample-resources/phi/texture/ball/albedo.png";
